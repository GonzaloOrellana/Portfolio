document.addEventListener('DOMContentLoaded', () => {
    ...
    const projectDetailPages = ['detalle-churn', 'detalle-aisha', 'detalle-pablo', 'detalle-zalostore', 'detalle-generador', 'detalle-inventario', 'detalle-focus', 'detalle-ucm-tracker'];
